...
class SawyerDoorEnvV2(SawyerXYZEnv):
    def __init__(self, view, train, random_init_obj_pos):
        ...
        self.init_config = {
            ...
            'hand_init_pos': np.array([0.1, 0.4, 0.2]),
        }
    ...
    def reset_model(self, seed=None):
        ...
        # np.random.seed(seed=0) # this ensures that every time we reset, we get the same initial obj positions
